...
/**
 * @brief class, child of character and parent of classNPC, that holds artificial intelligence methods used by NPC class
 */
class artificial_intelligence : public character
{
