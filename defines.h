...
enum ANIM_TYPE {
    ...
    ANIM_TYPE_GOT_ITEM,
    ANIM_TYPE_CROUCHING,
    ANIM_TYPE_LOOK_FORWARD,
    ANIM_TYPE_EFFECT_SLIME,
...
enum ANIM_TYPE_NPC {
    ANIM_TYPE_NPC_STAND,
    ANIM_TYPE_NPC_WALK,
    ANIM_TYPE_NPC_GOT_ITEM,
    ANIM_TYPE_NPC_GIVE_ITEM,
    ANIM_TYPE_NPC_TALK,
    ANIM_TYPE_NPC_COUNT
};
#define ANIM_TYPE_NPC_FRAMES_N 2
...
enum E_TILE_COLLISION_SHAPE {
    COLLISION_SHAPE_NONE,
    COLLISION_SHAPE_RECTANGLE,
    COLLISION_SHAPE_POLYGON
};
