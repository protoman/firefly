...
short game_menu::show_main_config(short stage_finished, bool called_from_game)
{
    ...
    options.push_back(st_menu_option(strings_map::get_instance()->get_ingame_string(strings_ingame_audio, SharedData::get_instance()->current_language)));
    options.push_back(st_menu_option(strings_map::get_instance()->get_ingame_string(strings_ingame_input, SharedData::get_instance()->current_language)));
#if defined(PC)
...
#endif
    options.push_back(st_menu_option(strings_map::get_instance()->get_ingame_string(strings_ingame_language, SharedData::get_instance()->current_language)));

    options.push_back(st_menu_option(strings_map::get_instance()->get_ingame_string(strings_ingame_config_graphics_performance, SharedData::get_instance()->current_language)));

    options.push_back( strings_map::get_instance()->get_ingame_string(strings_ingame_extras, SharedData::get_instance()->current_language));

    if (called_from_game) {
        if (stage_finished) {
            options.push_back(st_menu_option(strings_map::get_instance()->get_ingame_string(strings_ingame_leavestage, SharedData::get_instance()->current_language)));
        } else {
            options.push_back(st_menu_option(strings_map::get_instance()->get_ingame_string(strings_ingame_leavestage, SharedData::get_instance()->current_language), true));
        }
        options.push_back( strings_map::get_instance()->get_ingame_string(strings_ingame_config_quitgame, SharedData::get_instance()->current_language));
    }
...
void game_menu::show_config_video()
{
    ...
    while (selected_option != -1) {
        ...
        if (SharedData::get_instance()->game_config.video_fullscreen == false) {
            options.push_back(strings_map::get_instance()->get_ingame_string(strings_ingame_mode, SharedData::get_instance()->current_language) + std::string(": ") + strings_map::get_instance()->get_ingame_string(strings_ingame_video_windowed, SharedData::get_instance()->current_language));
        } else {
            options.push_back(strings_map::get_instance()->get_ingame_string(strings_ingame_mode, SharedData::get_instance()->current_language) + std::string(": ") + strings_map::get_instance()->get_ingame_string(strings_ingame_video_fullscreen, SharedData::get_instance()->current_language));
        }
...
void game_menu::show_config_ask_restart()
{
    ...
    TextView::get_instance()->renderText(menu_pos.x, menu_pos.y, st_color(TEXT_DEFAUL_COLOR_VALUE, TEXT_DEFAUL_COLOR_VALUE, TEXT_DEFAUL_COLOR_VALUE), false, strings_map::get_instance()->get_ingame_string(strings_ingame_config_restart1, SharedData::get_instance()->current_language));
...
void game_menu::show_config_audio()
{
    ...
    while (selected_option != -1) {
        ...
        if (SharedData::get_instance()->game_config.sound_enabled == true) {
            options.push_back(strings_map::get_instance()->get_ingame_string(strings_ingame_mode, SharedData::get_instance()->current_language) + std::string(": ") + strings_map::get_instance()->get_ingame_string(strings_ingame_config_enabled, SharedData::get_instance()->current_language));
        } else {
            options.push_back(strings_map::get_instance()->get_ingame_string(strings_ingame_mode, SharedData::get_instance()->current_language) + std::string(": ") + strings_map::get_instance()->get_ingame_string(strings_ingame_config_disabled, SharedData::get_instance()->current_language));
        }
        options.push_back(strings_map::get_instance()->get_ingame_string(strings_ingame_config_audio_volume_music, SharedData::get_instance()->current_language));
        options.push_back(strings_map::get_instance()->get_ingame_string(strings_ingame_config_audio_volume_sfx, SharedData::get_instance()->current_language));
        option_picker main_config_picker(false, config_text_pos, options, true);
        main_config_picker.draw();
        selected_option = main_config_picker.pick(selected_option+1);
        if (selected_option == 0) {
            ...
            config_int_value(ini_val, 1, 128);
...
void game_menu::show_config_performance()
{
    ...
    while (selected_option != -1) {
        ...
        if (SharedData::get_instance()->game_config.graphics_performance_mode == PERFORMANCE_MODE_LOW) {
            options.push_back(strings_map::get_instance()->get_ingame_string(strings_ingame_mode, SharedData::get_instance()->current_language) + std::string(": ") + strings_map::get_instance()->get_ingame_string(strings_config_low, SharedData::get_instance()->current_language));
        } else if (SharedData::get_instance()->game_config.graphics_performance_mode == PERFORMANCE_MODE_NORMAL) {
            options.push_back(strings_map::get_instance()->get_ingame_string(strings_ingame_mode, SharedData::get_instance()->current_language) + std::string(": ") + strings_map::get_instance()->get_ingame_string(strings_config_medium, SharedData::get_instance()->current_language));
        } else {
            options.push_back(strings_map::get_instance()->get_ingame_string(strings_ingame_mode, SharedData::get_instance()->current_language) + std::string(": ") + strings_map::get_instance()->get_ingame_string(strings_config_high, SharedData::get_instance()->current_language));
        }

        if (GameManager::get_instance()->get_show_fps_enabled()) {
            options.push_back(strings_map::get_instance()->get_ingame_string(strings_ingame_video_show_fps, SharedData::get_instance()->current_language) + std::string(": ") + strings_map::get_instance()->get_ingame_string(strings_ingame_config_on, SharedData::get_instance()->current_language));
        } else {
            options.push_back(strings_map::get_instance()->get_ingame_string(strings_ingame_video_show_fps, SharedData::get_instance()->current_language) + std::string(": ") + strings_map::get_instance()->get_ingame_string(strings_ingame_config_off, SharedData::get_instance()->current_language));
        }
...
void game_menu::show_config_warning_android_play_services()
{
    ...
    TextView::get_instance()->renderText(menu_pos.x, menu_pos.y, st_color(TEXT_DEFAUL_COLOR_VALUE, TEXT_DEFAUL_COLOR_VALUE, TEXT_DEFAUL_COLOR_VALUE), false, strings_map::get_instance()->get_ingame_string(strings_ingame_config_android_play_services1, SharedData::get_instance()->current_language));
    TextView::get_instance()->renderText(menu_pos.x, menu_pos.y+10, st_color(TEXT_DEFAUL_COLOR_VALUE, TEXT_DEFAUL_COLOR_VALUE, TEXT_DEFAUL_COLOR_VALUE), false, strings_map::get_instance()->get_ingame_string(strings_ingame_config_android_play_services2, SharedData::get_instance()->current_language));
...
void game_menu::show_config_warning_android_cloud_save()
{
    ...
    st_position menu_pos(ImageView::get_instance()->get_config_menu_pos().x + 24, ImageView::get_instance()->get_config_menu_pos().y + 40);
    ImageView::get_instance()->clearScreenArea(menu_pos.x, menu_pos.y, RES_W,  180, CONFIG_BGCOLOR_R, CONFIG_BGCOLOR_G, CONFIG_BGCOLOR_B);
    TextView::get_instance()->renderText(menu_pos.x, menu_pos.y, st_color(TEXT_DEFAUL_COLOR_VALUE, TEXT_DEFAUL_COLOR_VALUE, TEXT_DEFAUL_COLOR_VALUE), false, strings_map::get_instance()->get_ingame_string(strings_ingame_config_android_cloud_save1, SharedData::get_instance()->current_language));
    TextView::get_instance()->renderText(menu_pos.x, menu_pos.y+10, st_color(TEXT_DEFAUL_COLOR_VALUE, TEXT_DEFAUL_COLOR_VALUE, TEXT_DEFAUL_COLOR_VALUE), false, strings_map::get_instance()->get_ingame_string(strings_ingame_config_android_cloud_save2, SharedData::get_instance()->current_language));
...
void game_menu::config_int_value(int initial_value_int, int min, int max)
{
    ...
    while (keep_going) {
        ...
        if (InputController::get_instance()->p1_input[BTN_ATTACK] == 1 || InputController::get_instance()->p1_input[BTN_START] == 1 || InputController::get_instance()->p1_input[BTN_DOWN]) {
            keep_going = false;
        } else if (InputController::get_instance()->p1_input[BTN_LEFT] == 1 && initial_value > min) {
            initial_value--;
        } else if (InputController::get_instance()->p1_input[BTN_RIGHT] == 1 && initial_value < max) {
            initial_value++;
        }
