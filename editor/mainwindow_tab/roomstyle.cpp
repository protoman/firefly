...
{
    if (SharedData::get_instance()->v6_style_list.size() < 1) {
        return;
    }
    data_loading = true;
...
{
    ui->styleNameLineEdit->setText(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).style_name);
    ui->styleTilesetComboBox->setCurrentIndex(ui->styleTilesetComboBox->findText(QString(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).tileset_filename)));
    st_color bg_color = SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).background_color;
    ...
    ui->styleMusicFilenameComboBox->setCurrentIndex(ui->styleMusicFilenameComboBox->findText(QString(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).music_filename)));
    ui->styleGfxEffectComboBox->setCurrentIndex(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).gfx_effect);
    ui->styleGfxModeComboBox->setCurrentIndex(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).gfx_mode);
...
{
    std::cout << "#RoomStyle::set_layer_data - style[" << SharedData::get_instance()->room_style_selected_style << "], layer[" << SharedData::get_instance()->room_style_selected_layer << "], speed[" << SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].speed << "]" << std::endl;
    file_v6_style_layer debug = SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer];
    ui->layerSpeedDoubleSpinBox->setValue((float)SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].speed/(float)10);
    ui->layerVerticalPositionSpinBox->setValue(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].adjust_y);
    ui->layerAutoscrollComboBox->setCurrentIndex(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].auto_scroll);
    ui->layerAlphaSpinBox->setValue(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].alpha);
    ui->layerAnimationTimerSpinBox->setValue(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].animation_timer);
    ui->layerAnimationWidthSpinBox->setValue(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].animation_width);
    ui->layerRepeatXCheckBox->setChecked(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].repeatX);
    ui->layerRepeatYCheckBox->setChecked(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].repeatY);
    ui->layerImageComboBox->setCurrentIndex(ui->layerImageComboBox->findText(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].filename));
...
{
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).background_color.r = color.red();
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).background_color.g = color.green();
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).background_color.b = color.blue();
...
{
    if (data_loading) return;
    sprintf(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).style_name, "%s", arg1.toStdString().c_str());
}
...
{
    if (data_loading) return;
    sprintf(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).tileset_filename, "%s", arg1.toStdString().c_str());
}


void RoomStyle::on_StyleBackgroundColorPushButton_clicked()
{
    QColor currentColor = QColor(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).background_color.r, SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).background_color.g, SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).background_color.b, 255);
    QColorDialog *colorDialog = new QColorDialog(currentColor, this);
    colorDialog->setOption(QColorDialog::DontUseNativeDialog, true);
    QObject::connect(colorDialog, SIGNAL(colorSelected(QColor)), this, SLOT(on_color_selected1(QColor)));
    colorDialog->show();
...
{
    if (data_loading) return;
    sprintf(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).music_filename, "%s", arg1.toStdString().c_str());
}
...
{
    if (data_loading) return;
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).gfx_effect = index;
}
...
{
    if (data_loading) return;
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).gfx_mode = index;
}
...
{
    if (data_loading) return;
    sprintf(SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].filename, "%s", arg1.toStdString().c_str());
    ui->areaEditPreviewWidgetObj->update_files();
    ui->areaEditPreviewWidgetObj->repaint();
}
...
{
    if (data_loading) return;
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].adjust_y = arg1;
    ui->areaEditPreviewWidgetObj->repaint();
}
...
{
    if (data_loading) return;
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].speed = arg1*10;
...
{
    if (data_loading) return;
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].auto_scroll = index;
    ui->areaEditPreviewWidgetObj->repaint();
}
...
{
    if (data_loading) return;
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].animation_timer = arg1;
    ui->areaEditPreviewWidgetObj->repaint();
}
...
{
    if (data_loading) return;
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].animation_width = arg1;
    ui->areaEditPreviewWidgetObj->repaint();
}
...
{
    if (data_loading) return;
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].repeatX = checked;
    ui->areaEditPreviewWidgetObj->repaint();
}
...
{
    if (data_loading) return;
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].repeatY = checked;
    ui->areaEditPreviewWidgetObj->repaint();
}
...
{
    if (data_loading) return;
    SharedData::get_instance()->v6_style_list.at(SharedData::get_instance()->room_style_selected_style).layers[SharedData::get_instance()->room_style_selected_layer].alpha = arg1;
    ui->areaEditPreviewWidgetObj->repaint();
}
